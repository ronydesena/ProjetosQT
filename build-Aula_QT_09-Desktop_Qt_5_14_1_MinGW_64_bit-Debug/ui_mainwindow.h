...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(388, 277);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(30, 10, 301, 101));
        label->setPixmap(QPixmap(QString::fromUtf8(":/imgs/Imagens/pagina.jpg")));
        label->setScaledContents(true);
        lb_logo = new QLabel(centralwidget);
        lb_logo->setObjectName(QString::fromUtf8("lb_logo"));
        lb_logo->setGeometry(QRect(70, 140, 71, 71));
